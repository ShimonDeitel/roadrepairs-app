...
struct SettingsView: View {
    @AppStorage("roadrepairs.notifyEnabled") private var notifyEnabled: Bool = true
    @AppStorage("roadrepairs.compactMode") private var compactMode: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/roadrepairs-app/privacy.html")!)
                    Text("Version 1.0")
